...
def index(request):
    ...
    page = Paginator(backtests, BACKTEST_PAGE_SIZE).get_page(request.GET.get("page"))
    return render(request, "backtesting/index.html", {"backtests": page, "page": page})
